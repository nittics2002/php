...
trait BridgeTrait
{
    ...
    *   @return object
    */
    abstract protected function convertToOriginal(
        object $delegator
    ):object;
    ...
    *   @return object
    */
    abstract protected function convertToDelegator(
        object $original
    ):object;
    ...
    *   @return string
    */
    protected function originalNamespace():string
    {
    ...
    *   @return string
    */
    protected function delegatorNamespace():string
    {
    ...
    *   @return bool
    */
    protected function isOriginalObject(mixed $target):bool
    {
        return is_object($target) &&
            is_a($target, $this->originalNamespace());
    }
    ...
    *   @return bool
    */
    protected function isDelegatorObject(mixed $target):bool
    {
        return is_object($target) &&
            is_a($target, $this->delegatorNamespace());
    }
    ...
    *   @return object
    */
    protected function constructDelegator(
        array $arguments
    ):object{
    ...
    *   @return array
    */
    protected function convertAllArgumentsUgingDelegator(
        array $arguments
    ):object {
        $delegated = [];
