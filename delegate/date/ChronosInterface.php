 ...
 *
 * @copyright     Copyright (c) Cake Software Foundation, Inc. (http://cakefound
ation.org)
...
interface ChronosInterface extends DateTimeInterface
{
     ...
     *
     * @param \DateTimeZone|string|null $tz The DateTimeZone object or timezone
name.
     * @return static
     */
     ...
     * @return static
     */
    public function setDateTime(int $year, int $month, int $day, int $hour, int
$minute, int $second = 0): self;
     ...
     *
     * @param \DateTimeZone|string $value The DateTimeZone object or timezone na
me to use.
     * @return static
     */
...
me to use.
     ...
     * @param bool $equal Indicates if a > and < comparison should be used or <=
 or >=
     * @return bool
     */
    public function between(ChronosInterface $dt1, ChronosInterface $dt2, bool $
equal = true): bool;
...
urrent instance.
     *
     * @param \Cake\Chronos\ChronosInterface|null $dt The instance to compare wi
th.
     * @return static
     */
...
th.
     ...
     *
     * ```
     *  (new Chronos('2012-02-29'))->addYearsWithOverflow(1); // Results in 2013
-03-01
     * ```
     *
     * @param int $value The number of years to add.
     ...
     *
     * ```
     *  (new Chronos('2012-01-30'))->addMonthsWithOverflow(1); // Results in 201
3-03-01
     * ```
     *
     * @param int $value The number of months to add.
     ...
     * 5 months after
     *
     * @param \Cake\Chronos\ChronosInterface|null $other The datetime to compare
 with.
     * @param bool $absolute Removes time difference modifiers ago, after, etc
     * @return string
     */
    public function diffForHumans(?ChronosInterface $other = null, bool $absolut
e = false): string;

    /**
     * Get the difference in years
     *
     * @param \Cake\Chronos\ChronosInterface|null $dt The instance to difference
 from.
     * @param bool $abs Get the absolute of the difference
     * @return int
     */
    public function diffInYears(?ChronosInterface $dt = null, bool $abs = true):
 int;
 ...
 from.
     ...
     * @return int
     */
    public function diffInMonths(?ChronosInterface $dt = null, bool $abs = true)
: int;
 ...
 from.
     ...
     * @return int
     */
    public function diffInWeeks(?ChronosInterface $dt = null, bool $abs = true):
 int;
 ...
 from.
     ...
     * @return int
     */
    public function diffInDays(?ChronosInterface $dt = null, bool $abs = true):
int;
 ...
 from.
     ...
     * @return int
     */
    public function diffInDaysFiltered(callable $callback, ?ChronosInterface $dt
 = null, bool $abs = true): int;
 ...
 from.
     ...
     * @return int
     */
    public function diffInHoursFiltered(callable $callback, ?ChronosInterface $d
t = null, bool $abs = true): int;
 ...
 from.
     ...
     * @return int
     */
    public function diffInWeekdays(?ChronosInterface $dt = null, bool $abs = tru
e): int;
 ...
 from.
     ...
     * @return int
     */
    public function diffInWeekendDays(?ChronosInterface $dt = null, bool $abs =
true): int;
 ...
 from.
     ...
     * @return int
     */
    public function diffInHours(?ChronosInterface $dt = null, bool $abs = true):
 int;
 ...
 from.
     ...
     * @return int
     */
    public function diffInMinutes(?ChronosInterface $dt = null, bool $abs = true
): int;
 ...
 from.
     ...
     * @return int
     */
    public function diffInSeconds(?ChronosInterface $dt = null, bool $abs = true
): int;
...
:59
     ...
     * Use the supplied consts to indicate the desired dayOfWeek, ex. static::MO
NDAY.
     *
...
s.
     ...
     *
     * @param string|int $timeInterval the numeric value with space then time ty
pe.
